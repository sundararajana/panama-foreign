...
public class Clong_long {
    ...
    public static final MemoryLayout LAYOUT = C_LONGLONG;
    ...
    public static MemoryAddress allocate(long value, CScope scope) {
    ...
    public static MemoryAddress allocateArray(long[] arr, CScope scope) {
        MemoryLayout arrLayout = MemoryLayout.ofSequence(arr.length, LAYOUT);
