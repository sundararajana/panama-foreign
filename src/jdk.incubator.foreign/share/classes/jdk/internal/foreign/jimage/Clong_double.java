...
public class Clong_double {
    ...
    public static final MemoryLayout LAYOUT = C_LONGDOUBLE;
    public static final Class<?> CARRIER = double.class;
    ...
    public static void set(MemoryAddress addr, double value) {
        handle.set(addr, value);
    }

    public static double get(MemoryAddress addr, long index) {
        return (double) arrayHandle.get(addr, index);
    }

    public static void set(MemoryAddress addr, long index, double value) {
        arrayHandle.set(addr, index, value);
    }

    public static MemorySegment allocate(double value) {
    ...
    public static MemorySegment allocateArray(double[] arr) {
        MemoryLayout arrLayout = MemoryLayout.ofSequence(arr.length, LAYOUT);
        MemorySegment seg = MemorySegment.allocateNative(arrLayout);
    ...
    public static MemoryAddress allocateArray(double[] arr, CScope scope) {
        MemoryLayout arrLayout = MemoryLayout.ofSequence(arr.length, LAYOUT);
        MemoryAddress addr = scope.allocate(arrLayout);
